package net.gray.examplemod.entity.custom;
...
public class MagicPigEntity extends Animal implements ItemSteerable, Saddleable {
    private static final EntityDataAccessor<Boolean> DATA_SADDLE_ID = SynchedEntityData.defineId(net.minecraft.world.entity.animal.Pig.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_BOOST_TIME = SynchedEntityData.defineId(net.minecraft.world.entity.animal.Pig.class, EntityDataSerializers.INT);
    private final ItemBasedSteering steering = new ItemBasedSteering(this.entityData, DATA_BOOST_TIME, DATA_SADDLE_ID);

    public MagicPigEntity(EntityType<? extends MagicPigEntity> pEntityType, Level pLevel) {
    ...
    @Nullable
    public net.minecraft.world.entity.animal.Pig getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
